...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，I am a simple student is studying codes @scnu🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Clivia', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'a simple student🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.clivia.fun', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Clivia, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '3254822118@qq.com', // 
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/Yanyutin753',
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://avatars.githubusercontent.com/u/132346501?v=4', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  IMG_LAZY_LOAD_PLACEHOLDER:
    ...
    'https://www.notion.so/images/page-cover/nasa_space_shuttle_challenger.jpg', // 懒加载占位图片地址，支持base64或url
